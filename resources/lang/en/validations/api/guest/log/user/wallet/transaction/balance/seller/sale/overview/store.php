...
return [
    ...
    */
    ...
    'data' => [
        ...
        'sale' => [
            'required' => 'The sale field is required.',
            'array'    => 'The sale field must be an array.',
            'id' => [
    ...
    'result' => [
        'error' => [
            'find'   => [
                'balanceSellerSaleOverviewLog' => 'Failed to find a balance seller sale overview log.',
